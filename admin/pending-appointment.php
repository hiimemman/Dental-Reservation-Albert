            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="insert">
                        ...
                        <div class="mb-3">
                            <label for="view_service" class="col-form-label">Other Request</label>
                    ...
                    <form id="update">
                        ...
                        <div class="mb-3 d-none cancelled_cont">
                            ...
                            <select class="form-select"  name="reason"
                                ...
                                <option value="Dentist is in Vacation">Dentist is in Vacation</option>
                        ...
                        <div class="mb-3 d-none appointment_time_cont">
                            <label for="update_status" class="col-form-label">Appointment Time</label>
                            <input type="time" class="form-control" id="update_appointment_time"
                                name="update_appointment_time" min="09:00" max="17:00" required>
                                <p>Note: Opens 9:00am to 5:00pm</p>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
...
$(document).ready(function() {
    ...
    var dataTable = $('#tableData').DataTable({
        ...
        "sScrollXInner": "100%",
        "ajax": {
            url: "./tables/pending-appointment.php",
            type: "post"
        },
        "order": [
            [0, 'asc']
    ...
    $(document).on('click', '#get_view', function(e) {
        ...
        $.ajax({
            url: './functions/pending-appointment.php',
            type: 'POST',
    ...
    $(document).on('change', '#update_status', function(e) {
        ...
        if ($('#update_status').val() == 'CANCELLED') {
            ...
            $('.appointment_time_cont').addClass('d-none');
            $('#update_appointment_time').prop('required', false);
        } else {
            $('.cancelled_cont').addClass('d-none');
            $('#update_reason').prop('required', false);
            $('.appointment_time_cont').removeClass('d-none');
            $('#update_appointment_time').prop('required', true);
        }
    })
