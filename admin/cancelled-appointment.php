                    ...
                    <form id="insert">
                        ...
                        <div class="mb-3 row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="view_firstname" name="view_firstname"
                                    required readonly>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="tel" id="view_contact" name="view_contact" class="form-control"
                                        required readonly />
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="view_reason" class="col-form-label">Reason</label>
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="view_reason"
                                    name="view_reason" style="height: 100px; resize: none;"></textarea>
...
$(document).ready(function() {
    ...
    var dataTable = $('#tableData').DataTable({
        ...
        "sScrollXInner": "100%",
        "ajax": {
            url: "./tables/cancelled-appointment.php",
            type: "post"
        },
        "order": [
            [3, 'asc']
    ...
    $(document).on('click', '#get_view', function(e) {
        ...
        $.ajax({
            url: './functions/cancelled-appointment.php',
            type: 'POST',
